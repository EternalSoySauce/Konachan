...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int tabViewPaddingDp = TAB_VIEW_PADDING_DIPS;
    ...
    public void setTabViewPaddingDp(int tabViewPaddingDp) {
        this.tabViewPaddingDp = tabViewPaddingDp;
    }
    ...
    public void setTabViewTextSizeSp(int tabViewTextSizeSp) {
        this.tabViewTextSizeSp = tabViewTextSizeSp;
    }
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        int padding = (int) (tabViewPaddingDp * getResources().getDisplayMetrics().density);
