...
public class CircleLoadingView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.CircleLoadingView, defStyle, 0);
        int color1 = a.getColor(R.styleable.CircleLoadingView_color1, RED);
        int color2 = a.getColor(R.styleable.CircleLoadingView_color2, YELLOW);
        int color3 = a.getColor(R.styleable.CircleLoadingView_color3, BLUE);
        a.recycle();
